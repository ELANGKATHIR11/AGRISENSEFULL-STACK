...
_db = _get_db()
_readings: Collection = _db["readings"]
_reco: Collection = _db["reco_history"]
_tank: Collection = _db["tank_levels"]
_valves: Collection = _db["valve_events"]
_alerts: Collection = _db["alerts"]
_rain: Collection = _db["rainwater_harvest"]
