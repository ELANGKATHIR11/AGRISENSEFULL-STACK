...
def main():
    ...
    water_model.fit(Xtr, yw_tr, validation_data=(Xva, yw_va), epochs=20, batch_size=64, verbose=0)
    ...
    fert_norm.adapt(Xtr)
    fert_model.fit(Xtr, yf_tr, validation_data=(Xva, yf_va), epochs=25, batch_size=64, verbose=0)
